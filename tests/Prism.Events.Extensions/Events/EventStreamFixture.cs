...
//            Assert.Equal(
//                typeof(Prism.Events.Extensions.EventSubscription<string>),
...
//            Assert.Equal(
//                typeof(Prism.Events.Extensions.BackgroundEventSubscription<string>),
//                stream.BaseSubscriptions.Single().GetType());
//        }
...
//            Assert.Equal(
//                typeof(Prism.Events.Extensions.DispatcherEventSubscription<string>),
//                stream.BaseSubscriptions.Single().GetType());
//        }
...
//            Assert.Equal(typeof(Prism.Events.Extensions.EventSubscription<string>), PubSubEvent.BaseSubscriptions.ElementAt(0).GetType());
//        }


//        // ── Test doubles ──────────────────────────────────────────────────────────

//        private class TestableEventStream<TPayload> : ReplayEvent<TPayload>
//        {
//            public ICollection<IEventSubscription> BaseSubscriptions => Subscriptions;
//        }

//        private class SmallBacklogEventStream<TPayload> : ReplayEvent<TPayload>
//        {
